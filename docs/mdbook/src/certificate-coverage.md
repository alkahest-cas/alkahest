...
Corpus: **275 observations** over **178 shape classes** — 66 certified, 2 conditional, 0 partial, 110 withheld.
...
65 shape classes — 27 certified, 38 withheld.
...
44 shape classes — 15 certified, 29 withheld.
...
17 shape classes — 2 certified, 15 withheld.
...
| ⛔ withheld | `form=product, funcs=-, fn_arg=none, mul=general, pow=neg, pow_base=expr` | `(((-1 * 1) + x)^-1 * ((-1 * 1) + x^2))`, `(((-1 * 2) + x)^-1 * ((-1 * 4) + x^2))`, `(((2 * x) + (3 * x^2)) * (1 + x^2)^-1)` | — |
