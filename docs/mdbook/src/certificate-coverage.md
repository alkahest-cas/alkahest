...
Corpus: **283 observations** over **184 shape classes** — 74 certified, 2 conditional, 0 partial, 108 withheld.
...
67 shape classes — 33 certified, 34 withheld.
...
| ⛔ withheld | `form=product, funcs=exp, fn_arg=other, mul=general, pow=neg, pow_base=expr` | `((exp((-1 * x)))^-1 * C2)`, `((exp((-1/2 * x^2)))^-1 * C2)`, `((exp((-3 * x)))^-1 * C2)` | `diff_exp`, `power_rule`, `product_rule` |
...
| ⛔ withheld | `form=sum, funcs=sqrt, fn_arg=other, mul=general, pow=neg, pow_base=var` | `((-1 * sqrt((1 + x^2)) * x^-1) + 1)` | `diff_sqrt`, `power_rule`, `product_rule`, `sum_rule` |

## `integrate`

47 shape classes — 17 certified, 30 withheld.
...
| ⛔ withheld | `form=product, funcs=-, fn_arg=none, mul=general, pow=neg, pow_base=one_plus_sq, definite=no` | `((1 + x^2)^-1 * x)` | — |
| ⛔ withheld | `form=product, funcs=-, fn_arg=none, mul=general, pow=neg, pow_base=one_plus_sq, definite=yes` | `((1 + x^2)^-1 * x)` | — |
| ✅ certified | `form=product, funcs=-, fn_arg=none, mul=scalar, pow=nat, pow_base=var, definite=yes` | `(1/2 * x^2)` | — |
| ⛔ withheld | `form=product, funcs=-, fn_arg=none, mul=scalar, pow=neg, pow_base=expr, definite=no` | `((((-1 * 1) + x)^2)^-1 * 1)`, `((4 + x^2)^-1 * 1)` | — |
| ⛔ withheld | `form=product, funcs=-, fn_arg=none, mul=scalar, pow=neg, pow_base=expr, definite=yes` | `((1 + x)^-1 * 1)`, `((4 + x^2)^-1 * 1)`, `((x^2)^-1 * 1)` | — |
| ✅ certified | `form=product, funcs=-, fn_arg=none, mul=scalar, pow=neg, pow_base=one_plus_sq, definite=no` | `((1 + x^2)^-1 * 1)` | — |
| ✅ certified | `form=product, funcs=-, fn_arg=none, mul=scalar, pow=neg, pow_base=one_plus_sq, definite=yes` | `((1 + x^2)^-1 * 1)` | — |
...
| ⛔ withheld | `form=product, funcs=exp, fn_arg=var, mul=general, pow=neg, pow_base=var, definite=no` | `(exp(x) * x^-1)` | — |
...
| ⛔ withheld | `form=product, funcs=sin, fn_arg=var, mul=general, pow=neg, pow_base=var, definite=no` | `(sin(x) * x^-1)` | — |
...
| ⛔ withheld | `form=product, funcs=-, fn_arg=none, mul=general, pow=neg, pow_base=expr` | `(((-1 * 1) + x)^-1 * ((-1 * 1) + x^2))`, `(((-1 * 2) + x)^-1 * ((-1 * 4) + x^2))`, `(((2 * x) + 1) * (3 + x^2)^-1)` | — |
| ⛔ withheld | `form=product, funcs=-, fn_arg=none, mul=general, pow=neg, pow_base=one_plus_sq` | `(((2 * x) + (3 * x^2)) * (1 + x^2)^-1)`, `((1 + x^2)^-1 * x^3)` | — |
| ⛔ withheld | `form=product, funcs=-, fn_arg=none, mul=scalar, pow=neg, pow_base=var` | `(1 * x^-1)` | — |
| ⛔ withheld | `form=product, funcs=cos, fn_arg=var, mul=general, pow=neg, pow_base=expr` | `(((-1 * cos(x)) + 1) * (x^2)^-1)` | — |
| ⛔ withheld | `form=product, funcs=exp, fn_arg=other, mul=general, pow=neg, pow_base=var` | `(((-1 * 1) + exp((2 * x))) * x^-1)` | — |
| ⛔ withheld | `form=product, funcs=exp, fn_arg=var, mul=general, pow=neg, pow_base=expr` | `(((-1 * 1) + (-1 * x) + exp(x)) * (x^2)^-1)` | — |
| ⛔ withheld | `form=product, funcs=exp, fn_arg=var, mul=general, pow=neg, pow_base=var` | `(((-1 * 1) + exp(x)) * x^-1)`, `(exp(x) * x^-1)` | — |
| ⛔ withheld | `form=product, funcs=log, fn_arg=other, mul=general, pow=neg, pow_base=var` | `(log((1 + x)) * x^-1)` | — |
| ⛔ withheld | `form=product, funcs=log, fn_arg=var, mul=general, pow=neg, pow_base=expr` | `(((-1 * 1) + x)^-1 * log(x))` | — |
| ⛔ withheld | `form=product, funcs=log, fn_arg=var, mul=general, pow=neg, pow_base=var` | `(log(x) * x^-1)` | — |
| ⛔ withheld | `form=product, funcs=log, fn_arg=var, mul=general, pow=none, pow_base=none` | `(log(x) * x)` | — |
| ⛔ withheld | `form=product, funcs=sin, fn_arg=var, mul=general, pow=neg, pow_base=var` | `(sin(x) * x^-1)` | — |
| ⛔ withheld | `form=product, funcs=sqrt, fn_arg=other, mul=general, pow=neg, pow_base=var` | `(((-1 * 1) + sqrt((1 + x))) * x^-1)` | — |
...
| ⛔ withheld | `form=product, funcs=sin, fn_arg=other, mul=general, pow=neg` | `((sin(x))^-1 * 1 * sin(x))` | — |
| ✅ certified | `form=sum, funcs=cos,sin,tan, fn_arg=other, mul=general, pow=neg` | `(((cos(x))^-1 * -1 * sin(x)) + tan(x))`, `(((cos(x))^-1 * sin(x)) + (-1 * tan(x)))` | — |
