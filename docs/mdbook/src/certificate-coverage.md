...
| ⛔ withheld | `form=product, funcs=-, fn_arg=none, mul=general, pow=neg_one, pow_base=expr, definite=yes` | `(((1 + k) * k)^-1 * 1)` | `gosper_definite_telescope` |
