...
pub use crate::kernel::expr_props::{expr_contains_noncommutative_symbol, mult_tree_is_commutative};
...
impl RewriteRule for PauliSpinAlgebraRule {
    ...
    fn apply(&self, expr: ExprId, pool: &ExprPool) -> Option<(ExprId, crate::deriv::log::DerivationLog)> {
